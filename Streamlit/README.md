...
print(conflicts)
```
   # model-generated warnings (for example, invalid lane/destination combos)
   # are captured and displayed above the results so that users see them
   # immediately instead of only in the console.
